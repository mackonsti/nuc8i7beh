...
DefinitionBlock ("SSDT-EC-USBX.aml", "SSDT", 2, "Clover", "FakeEC", 0x00000000)
{
    External (_SB_.PCI0.LPCB, DeviceObj)
    External (_SB_.PCI0.LPCB.H_EC, DeviceObj)

    // Do NOT rename EC0, H_EC, etc. to EC as these devices are incompatible with macOS
    // and may break at any time; AppleACPIEC kext must NOT load. If your motherboard has
    // an existing Embedded Controller of PNP0C09 type, use the code below to disable it.
